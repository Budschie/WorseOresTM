...
public class ModBlockTagsProvider extends TagsProvider<Block>
{
	...
	protected void addTags()
	{
		...
		addTags(BlockTags.MINEABLE_WITH_PICKAXE, COPPER_ORE, COMPRESSED_ALOTOSTUFFIUM, AMADEUM_ORE, APPETITE_ORE, ENDERITE_ORE, EXPLODEMITE_ORE, IDLIKEABITE_ORE, SMITEANDLITE_ORE, NOFITE_ORE, KILLIUM_ORE, RANDOMIUM_ORE, DOGECOIN_ORE, MOBIUM_ORE, DREAMIUM_ORE, TRIPLITE_ORE, LITEINNITE_ORE, MEMENITE_ORE, BESTFORGE_ORE, DEEPSLATE_DIAMOND_ORE, DIAMOND_BLOCK, DEEPSLATE_ALOTOSTUFFIUM_ORE, DEEPSLATE_KILLIUM_ORE, DEEPSLATE_RANDOMIUM_ORE);
		addTags(BlockTags.NEEDS_STONE_TOOL, COPPER_ORE, COMPRESSED_ALOTOSTUFFIUM, AMADEUM_ORE, APPETITE_ORE, ENDERITE_ORE, EXPLODEMITE_ORE, IDLIKEABITE_ORE, SMITEANDLITE_ORE, NOFITE_ORE, KILLIUM_ORE, RANDOMIUM_ORE, DOGECOIN_ORE, MOBIUM_ORE, DREAMIUM_ORE, TRIPLITE_ORE, LITEINNITE_ORE, MEMENITE_ORE, DEEPSLATE_DIAMOND_ORE, DIAMOND_BLOCK, DEEPSLATE_ALOTOSTUFFIUM_ORE, DEEPSLATE_KILLIUM_ORE, DEEPSLATE_RANDOMIUM_ORE);
