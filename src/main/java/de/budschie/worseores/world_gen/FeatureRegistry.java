...
public class FeatureRegistry
{
	...
	public static void addFeatures()
	{
		COPPER_FEATURE = register(new ResourceLocation(References.MODID, "copper_ore_feature"), 
				Feature.ORE, new OreConfiguration(OreFeatures.NATURAL_STONE, BlockRegistry.COPPER_ORE.get().defaultBlockState(), 12));
		
		ALOTOSTUFFIUM_FEATURE = register(new ResourceLocation(References.MODID, "alotostuffium_ore_feature"), 
				Feature.ORE, new OreConfiguration(OreFeatures.NATURAL_STONE, BlockRegistry.ALOTOSTUFFIUM_ORE.get().defaultBlockState(), 7));
		
		AMADEUM_FEATURE = register(new ResourceLocation(References.MODID, "amadeum_ore_feature"), 
				Feature.ORE, new OreConfiguration(OreFeatures.NATURAL_STONE, BlockRegistry.AMADEUM_ORE.get().defaultBlockState(), 5));
		...
		ENDERITE_FEATURE = register(new ResourceLocation(References.MODID, "enderite_ore_feature"), 
				Feature.ORE, new OreConfiguration(OreFeatures.NATURAL_STONE, BlockRegistry.ENDERITE_ORE.get().defaultBlockState(), 4));
		
		EXPLODEMITE_FEATURE = register(new ResourceLocation(References.MODID, "explodemite_ore_feature"), 
				Feature.ORE, new OreConfiguration(OreFeatures.NATURAL_STONE, BlockRegistry.EXPLODEMITE_ORE.get().defaultBlockState(), 7));
		
		IDLIKEABITE_FEATURE = register(new ResourceLocation(References.MODID, "idlikeabite_ore_feature"), 
				Feature.ORE, new OreConfiguration(OreFeatures.NATURAL_STONE, BlockRegistry.IDLIKEABITE_ORE.get().defaultBlockState(), 10));
		
		SMITEANDLITE_FEATURE = register(new ResourceLocation(References.MODID, "smiteandlite_ore_feature"), 
				Feature.ORE, new OreConfiguration(OreFeatures.NATURAL_STONE, BlockRegistry.SMITEANDLITE_ORE.get().defaultBlockState(), 5));
		
		NOFITE_FEATURE = register(new ResourceLocation(References.MODID, "nofite_ore_feature"), 
				Feature.ORE, new OreConfiguration(OreFeatures.NATURAL_STONE, BlockRegistry.NOFITE_ORE.get().defaultBlockState(), 5));
		
		KILLIUM_FEATURE = register(new ResourceLocation(References.MODID, "killium_ore_feature"), 
				Feature.ORE, new OreConfiguration(OreFeatures.NATURAL_STONE, BlockRegistry.KILLIUM_ORE.get().defaultBlockState(), 5));
		
		RANDOMIUM_FEATURE = register(new ResourceLocation(References.MODID, "randomium_ore_feature"), 
				Feature.ORE, new OreConfiguration(OreFeatures.NATURAL_STONE, BlockRegistry.RANDOMIUM_ORE.get().defaultBlockState(), 3));
		
		MEMENITE_ORE = register(new ResourceLocation(References.MODID, "memenite_ore_feature"), 
				Feature.ORE, new OreConfiguration(OreFeatures.NATURAL_STONE, BlockRegistry.MEMENITE_ORE.get().defaultBlockState(), 5));
		
		LITEINNITE_ORE = register(new ResourceLocation(References.MODID, "liteinnite_ore_feature"), 
				Feature.ORE, new OreConfiguration(OreFeatures.NATURAL_STONE, BlockRegistry.LITEINNITE_ORE.get().defaultBlockState(), 10));
		
		BESTFORGE_ORE = register(new ResourceLocation(References.MODID, "bestforge_ore_feature"), 
				Feature.ORE, new OreConfiguration(OreFeatures.NATURAL_STONE, BlockRegistry.BESTFORGE_ORE.get().defaultBlockState(), 5));
	
		DOGECOIN_ORE = register(new ResourceLocation(References.MODID, "dogecoin_ore_feature"), 
				Feature.ORE, new OreConfiguration(OreFeatures.NATURAL_STONE, BlockRegistry.DOGECOIN_ORE.get().defaultBlockState(), 5));
	
		MOBIUM_ORE = register(new ResourceLocation(References.MODID, "mobium_ore_feature"), 
				Feature.ORE, new OreConfiguration(OreFeatures.NATURAL_STONE, BlockRegistry.MOBIUM_ORE.get().defaultBlockState(), 10));
		
		DREAMIUM_ORE = register(new ResourceLocation(References.MODID, "dreamium_ore_feature"), 
				Feature.ORE, new OreConfiguration(OreFeatures.NATURAL_STONE, BlockRegistry.DREAMIUM_ORE.get().defaultBlockState(), 5));
		
		DIAMOND_ORE = register(new ResourceLocation(References.MODID, "diamond_ore_feature"), 
				Feature.ORE, new OreConfiguration(OreFeatures.NATURAL_STONE, BlockRegistry.DIAMOND_ORE.get().defaultBlockState(), 8));
		
		TRIPLITE_ORE = register(new ResourceLocation(References.MODID, "triplite_ore_feature"), 
				Feature.ORE, new OreConfiguration(OreFeatures.NATURAL_STONE, BlockRegistry.TRIPLITE_ORE.get().defaultBlockState(), 6));
	}
