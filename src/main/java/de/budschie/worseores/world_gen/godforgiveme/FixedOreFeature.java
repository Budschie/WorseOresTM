package de.budschie.worseores.world_gen.godforgiveme;
...
// pain.
public class FixedOreFeature extends Feature<OreConfiguration> {
	   public FixedOreFeature(Codec<OreConfiguration> p_66531_) {
	      super(p_66531_);
	   }
	                                       ...
	                                       if (levelchunksection != null) {
	                                          ...
	                                          for(OreConfiguration.TargetBlockState oreconfiguration$targetblockstate : p_66535_.targetStates) {
	                                             if (canPlaceOre(blockstate, bulksectionaccess::getBlockState, p_66534_, p_66535_, oreconfiguration$targetblockstate, blockpos$mutableblockpos)) {
	                                                ...
	                                                if (p_66533_.getChunk(pos) instanceof ProtoChunk protoChunk)
	                                                {
